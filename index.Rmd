...
4. What is the average price of products per category on Amazon?
...
The purpose of Chart 1 is to create a histogram that displays ratings of the products in amazon_all along with the average price of items per category. This is intended to answer question 5: How are ratings of a product on Amazon correlated with the price of the product?

The insights from Chart 1 are that products with an average rating between 1 - 1.9 stars had a higher average price of product compared to anything rated 2 stars and above. For products rated between 1 - 1.9 stars, the average price was $40, which was greater than the other bins as seen in the chart below. Many factors could contribute to this higher average - some being that customers rated the product lower due to the high price, higher priced items may have had faulty parts, etc.
...
The purpose of Chart 2 is to find the relationship between price and purchases of a product in the amazon_all dataset. The findings are intended to answer or find insights toward question 2: Which Amazon product(s) have the most sales? This adds an extra relationship to look for - if price is related to number of purchases of a product.

The insights from Chart 2 show no clear relationship between price of an item and the number of purchases in the last month. But it can be said that it appears more people purchase cheaper items on Amazon, as majority of the points are clustered along the lower price range on the chart.
...
The purpose of Chart 3 is to answer research question 4: What is the average price of products per category on Amazon? This is done to find any relationships between categories and prices of items.

The insights from Chart 3 show the top 5 categories with the highest average price of products. There is not enough room to showcase more categories, but we can repeat this with lowest average prices to see what categories have cheaper and more expensive products, and if there is any correlation with how the product is rated as well.
